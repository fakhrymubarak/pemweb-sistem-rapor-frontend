        ...
        <div class="col-md-12">
          <div class="panel">
            ...
            <div class="panel-body">
              ...
              <form class="form-horizontal" method="post" action="<?= BASE_URL; ?>admin/runUpdateNilai/">
                    ...
                    ?>
                      <tr>
                        ...
                        <td style="width: 20%">
                          ...
                          <a href="<?= BASE_URL ?>admin/runDeleteNilai/<?= $rapor['id']; ?>" class="btn btn-danger">Delete</a>
                        </td>
                      </tr>
