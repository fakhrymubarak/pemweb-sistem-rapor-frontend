        ...
        <div class="col-md-12">
          <div class="panel">
            ...
            <div class="panel-body p-20">
              <a href="<?= BASE_URL; ?>admin/tambahMapel" class="btn btn-primary mb-20">Tambah Mata Pelajaran</a>
                ...
                <tbody>
                  ...
                  foreach ($listMapel as $jurusan) { ?>
                    <tr>
                      ...
                      <td style="width: 25%">
                        <a href="<?= BASE_URL; ?>admin/updateMapel/<?= $jurusan['id_mapel']; ?>" class="btn btn-warning">Edit</a>
                        <a href="<?= BASE_URL; ?>admin/runDeleteMapel/<?= $jurusan['id_mapel']; ?>" class="btn btn-danger">Delete</a>
                      </td>
                    </tr>
                  <?php $i++;
                  } ?>
