                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td style="width: 17%">
                        <a href="<?= BASE_URL; ?>guru/updateRapor/<?= $siswa['nis'] . "/" . $siswa['periode_nilai']; ?>" class="btn btn-warning">Detail</a>
                        <a href="<?= BASE_URL; ?>guru/detailRapor/<?= $siswa['nis'] . "/" . $siswa['id_kelas'] . "/" . $siswa['periode_nilai']; ?>" class="btn btn-primary">Preview</a>
                      </td>
                      </td>
                    </tr>
