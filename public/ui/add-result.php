...
?>
    ...
    <head>
        ...
        <title>Tambah Hasil Belajar</title>
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Tambahkan Hasil Belajar</h2>
                                </div>
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <form class="form-horizontal" method="post">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <select name="periode" class="form-control stid" id="periode" required="required" onChange="getresult(this.value);">
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="date" class="col-sm-2 control-label ">Nama Siswa:</label>
                                                        <div class="col-sm-10">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="date" class="col-sm-2 control-label">Mata Pelajaran:</label>
                                                        <div class="col-sm-10">
                                                            <div id="subject">
                                                            </div>
                                                        </div>
