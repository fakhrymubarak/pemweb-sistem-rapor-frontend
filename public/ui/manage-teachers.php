                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Kelola Data Guru</h2>
                                </div>
                            </div>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="active">Kelola Data </li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                                            ...
                                                            foreach ($results as $result) {   ?>
                                                                <tr>
                                                                    ...
                                                                    <td><?php if ($result->Status == 1) {
                                                                            ...
                                                                            echo htmlentities('Nonaktif');
                                                                        }
                                                                        ?></td>
                                                                    <td>
                                                                        <a href="edit-teachers.php?stid=<?php echo htmlentities($result->StudentId); ?>"><i class="fa fa-edit" title="Edit Record"></i> </a>
