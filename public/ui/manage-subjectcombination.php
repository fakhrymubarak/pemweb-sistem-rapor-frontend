...
?>
    ...
    <head>
        ...
        <title>Kelola Mapel Lintas Minat</title>
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Mata Pelajaran Lintas Minat</h2>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li> Mapel</li>
                                        <li class="active">Kelola Lintas Minat</li>
                                    </ul>
                                </div>
                                        ...
                                        <div class="panel">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <h5>Lihat Informasi Mata Pelajaran Lintas Minat</h5>
                                                </div>
                                            </div>
                                            <?php if ($msg) { ?>
