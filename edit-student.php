...
if (strlen($_SESSION['alogin']) == "") {
    ...
    if (isset($_POST['submit'])) {
        ...
        $msg = " | Update data berhasil dilakukan";
    }
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li>Siswa</li>
                                        <li><a href="manage-students.php">Kelola Data Siswa</a> </li>
                                                    ...
                                                    if ($query->rowCount() > 0) {
                                                        foreach ($results as $result) {  ?>
                                                            ...
                                                            <div class="form-group">
                                                                <label for="default" class="col-sm-2 control-label">Nama Lengkap:</label>
                                                                <div class="col-sm-10">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="default" class="col-sm-2 control-label">Nomor Induk (NIS):</label>
                                                                <div class="col-sm-10">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="default" class="col-sm-2 control-label">Email Siswa:</label>
                                                                <div class="col-sm-10">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="default" class="col-sm-2 control-label">Jenis Kelamin:</label>
                                                                <div class="col-sm-10">
                                                                    <?php $gndr = $result->Gender;
                                                                    if ($gndr == "Male") {
                                                                    ?>
                                                                        <input type="radio" name="gender" value="Male" required="required" checked>Laki-laki
                                                                        <input type="radio" name="gender" value="Female" required="required">Perempuan
                                                                    <?php } ?>
                                                                    <?php
                                                                    if ($gndr == "Female") {
                                                                    ?>
                                                                        <input type="radio" name="gender" value="Male" required="required">Laki-laki
                                                                        <input type="radio" name="gender" value="Female" required="required" checked>Perempuan
                                                                    <?php } ?>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                <label for="default" class="col-sm-2 control-label">Kelas:</label>
                                                                <div class="col-sm-10">
                                                                    <input type="text" name="classname" class="form-control" id="classname" value="<?php echo htmlentities($result->ClassName) ?>(<?php echo htmlentities($result->Section) ?>)">
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    ...
                                                                    <?php echo htmlentities($result->DOB) ?>" id="date">
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="default" class="col-sm-2 control-label">Tanggal Registrasi: </label>
                                                                <div class="col-sm-10">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    ...
                                                                    if ($stats == "1") {
                                                                    ?>
                                                                        <input type="radio" name="status" value="1" required="required" checked>Aktif 
                                                                        <input type="radio" name="status" value="0" required="required">Nonaktif
                                                                    <?php } ?>
                                                                    <?php
                                                                    if ($stats == "0") {
                                                                    ?>
                                                                        <input type="radio" name="status" value="1" required="required">Aktif 
                                                                        <input type="radio" name="status" value="0" required="required" checked>Nonaktif
                                                                    <?php } ?>
