                                        ...
                                        <div class="panel">
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <form name="chngpwd" method="post" \ onSubmit="return valid();">
                                                    ...
                                                    <div class="form-group has-success">
                                                        <label for="success" class="control-label">Ulangi Password Baru</label>
                                                        <div class="">
                                                    ...
                                                    <div class="form-group has-success">
                                                        ...
                                                        <div class="">
                                                            <button type="submit" name="submit" class="btn btn-success btn-labeled">Konfirmasi<span class="btn-label btn-label-right"><i class="fa fa-check"></i></span></button>
                                                        </div>
