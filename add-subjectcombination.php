                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Tambah Mapel Lintas Minat</h2>
                                </div>
                            </div>
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li> Mapel</li>
                                        <li class="active">Lintas Minat</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="panel">
                                        <div class="panel-heading">
                                            <div class="panel-title">
                                                <h5>Tambah Mata Pelajaran Lintas Minat</h5>
                                            </div>
                                        </div>
                                        <div class="panel-body">
                                            ...
                                            <form class="form-horizontal" method="post">
                                                ...
                                                <div class="form-group">
                                                    <label for="default" class="col-sm-2 control-label">Mata Pelajaran</label>
                                                    <div class="col-sm-10">
